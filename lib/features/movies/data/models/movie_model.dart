...
class Movies {
  ...
  Movies.fromJson(dynamic json) {
    ...
    slug = json['slug'];
    year = json['year'];
    // Safely parse rating which can be int, double, or string in the API response
    final _rating = json['rating'];
    if (_rating is num) {
      rating = _rating.toDouble();
    } else if (_rating is String) {
      rating = double.tryParse(_rating);
    } else {
      rating = null;
    }
